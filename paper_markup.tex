...
%DIF DEL 5_version_control/nmed_submission/paper.tex   Mon Apr 19 21:33:37 2021
%DIF ADD paper.tex                                     Mon Apr 26 22:54:43 2021
...
%DIF 135c136
%DIF <                                                             \affil{International Center for the Study of Institutions and Development (HSE University, Moscow, Russia)}
%DIF -------
                                                            \affil{International Center for the Study of Institutions and Development, HSE University} %DIF > 
%DIF -------
...
%DIF 150c151
%DIF <                                                             \affil{Economics Department of Ghent University}
%DIF -------
                                                            \affil{Department of Economics, Ghent University} %DIF > 
%DIF -------
...
We analyze COVID-19 vaccine acceptance across 15 survey samples covering ten low- and middle-income countries (LMICs) in Asia, Africa, and South America, \DIFdelbegin \DIFdel{and two higher income countries (Russia }\DIFdelend \DIFaddbegin \DIFadd{Russia (an upper-middle-income country), }\DIFaddend and the United States\DIFdelbegin \DIFdel{)}\DIFdelend . Standardized survey responses were collected from \DIFdelbegin \DIFdel{`}\DIFdelend 45,\DIFdelbegin \DIFdel{928individuals}\DIFdelend \DIFaddbegin \DIFadd{928 individuals}\DIFaddend . We find generally high willingness to take a COVID-19 vaccine in LMIC samples (80\% on average), considerably higher than in the United States (65\%) and Russia (30\%). Vaccine acceptance was primarily explained by an interest in personal protection against the disease, while concern about side effects was the most commonly expressed reason for reluctance. Health workers were the most trusted sources of information about COVID-19 vaccines. Our findings suggest that \DIFdelbegin \DIFdel{prioritizing efficient and equitable vaccine distribution to LMICs should yield highreturns in promoting global immunization. }\DIFdelend \DIFaddbegin \DIFadd{the average vaccine acceptance in these LMICs is high. Where acceptance remains below herd immunity thresholds, content-specific messaging highlighting vaccine efficacy and safety delivered by healthcare workers may be most effective. Social signaling and norm setting can also improve vaccine uptake. }\DIFaddend Interventions to promote vaccination in these \DIFdelbegin \DIFdel{contexts should }\DIFdelend \DIFaddbegin \DIFadd{countries should also }\DIFaddend focus on translating intentions into uptake\DIFdelbegin \DIFdel{and involve trusted health workers}\DIFdelend .

\newpage

A safe and effective vaccine against COVID-19 is a critical tool to control the pandemic. As of \DIFdelbegin \DIFdel{March 2}\DIFdelend \DIFaddbegin \DIFadd{April 23}\DIFaddend , 2021, there were \DIFdelbegin \DIFdel{76 }\DIFdelend \DIFaddbegin \DIFadd{91 }\DIFaddend vaccines in clinical development and \DIFdelbegin \DIFdel{16 }\DIFdelend \DIFaddbegin \DIFadd{20 }\DIFaddend had advanced to Stage 3 clinical trials.\textsuperscript{\protect\hyperlink{ref-who1}{1}} Following clinical trials, several vaccines have been approved in multiple countries and are being distributed across the globe. \DIFaddbegin \DIFadd{For instance, Comirnaty, the vaccine born out of collaboration between American, German, and Chinese pharmaceutical companies, was approved as of April 15, 2021 by the European Union and more than 50 other countries. The AstraZeneca vaccine is, as of April 15, 2021, the vaccine with most authorisations. }\DIFaddend At present, global vaccine distribution remains highly unequal, with much of the current supply directed toward high-income countries.\textsuperscript{\protect\hyperlink{ref-eiu}{2}}

While effective and equitable distribution of the vaccines is a key policy priority, ensuring the population's \DIFdelbegin \DIFdel{acceptance is equally important}\DIFdelend \DIFaddbegin \DIFadd{uptake is equally necessary}\DIFaddend . Acceptance of vaccines and trust in the institutions that administer them are likely key determinants of the success of any vaccination campaign.\textsuperscript{\protect\hyperlink{ref-defigueiredo2020lancet}{3}} Several studies \DIFdelbegin \DIFdel{investigate high-income country residents' }\DIFdelend \DIFaddbegin \DIFadd{have investigated }\DIFaddend willingness to take a potential COVID-19 vaccine \DIFdelbegin \DIFdel{.\textsuperscript{\protect\hyperlink{ref-boyon2020ipsos}{4},\protect\hyperlink{ref-Malik2020}{5}} Little is known about acceptance rates in low- and }\DIFdelend \DIFaddbegin \DIFadd{in high-income countries.\textsuperscript{\protect\hyperlink{ref-wouters2021challenges}{11}} While some studies include respondents from }\DIFaddend middle-income countries\DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{,\textsuperscript{\protect\hyperlink{ref-lazarus2020nature}{6},\protect\hyperlink{ref-wouters2021challenges}{11}} few of these are lower-middle income countries and none are low-income countries (LICs and }\DIFaddend LMICs), \DIFdelbegin \DIFdel{however, where the majority }\DIFdelend \DIFaddbegin \DIFadd{where half }\DIFaddend of the world's population resides \DIFdelbegin \DIFdel{.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{and where large-scale vaccination has yet to begin. Our study builds on existing work by presenting harmonized data from a large number of LMICs, primarily lower-middle and low-income countries, and by probing reasons for acceptance and hesitancy in addition to measuring acceptance rates.
}\DIFaddend Acceptance of childhood vaccination for common diseases ---such as measles (MCV), Bacille Calmette-Guérin (BCG) and diphtheria, tetanus, and pertussis (DTP)---is generally high in LMICs, providing reasons for optimism about future uptake of COVID-19 vaccines. Table \ref{tab:otherv} summarizes general vaccine acceptance and uptake of common childhood vaccines for the countries included in our study. \DIFaddbegin \DIFadd{Indeed, agreement on the importance of childhood vaccinations demonstrates marked differences between most LMICs and Russia and the United States. }\DIFaddend Still, existing studies on COVID-19 vaccine acceptance document large variation, both across and within countries, including in settings where overall vaccination rates are high. \DIFdelbegin \DIFdel{\textsuperscript{\protect\hyperlink{ref-boyon2020ipsos}{4}} }\DIFdelend These studies highlight concerns about COVID-19 vaccine safety, and particularly concerns about the speed of vaccine development, as reasons for hesitancy\DIFdelbegin \DIFdel{in higher income settings.Similar concerns may apply in LMICs.
}\DIFdelend \DIFaddbegin \DIFadd{.\textsuperscript{\protect\hyperlink{ref-boyon2020ipsos}{4},\protect\hyperlink{ref-wouters2021challenges}{11}}
}\DIFaddend 

Additional reasons for hesitancy may feature more prominently in \DIFaddbegin \DIFadd{poorer }\DIFaddend LMIC settings. \DIFdelbegin \DIFdel{Reported }\DIFdelend \DIFaddbegin \DIFadd{For example, reported }\DIFaddend COVID-19 mortality rates have consistently been lower in \DIFaddbegin \DIFadd{these }\DIFaddend LMICs relative to higher income countries.\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-mukherjee}{6}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-mukherjee}{12}\DIFaddend } If individuals \DIFdelbegin \DIFdel{in LMICs }\DIFdelend feel the risk of disease is less serious, they may be less inclined to accept perceived risks associated with taking a recently-developed vaccine. Previous studies \DIFaddbegin \DIFadd{of healthcare utilization in LMICs }\DIFaddend have also highlighted factors such as concerns about healthcare quality,\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-christensen2020building}{7}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-christensen2020building}{13}\DIFaddend } negative historical experiences,\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Lowes2018}{8}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Lowes2018}{14}\DIFadd{,}\protect\hyperlink{ref-martinez2021vaccines}{15}\DIFaddend } weak support from traditional leaders,\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Jegede2007}{9}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Jegede2007}{16}\DIFaddend } and mistrust in government\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-BLAIR201789}{10}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-BLAIR201789}{17}\DIFaddend } as barriers to \DIFdelbegin \DIFdel{healthcare utilization in LMICs}\DIFdelend \DIFaddbegin \DIFadd{uptake, which could apply to COVID-19 vaccination as well}\DIFaddend .

Understanding factors that may lead people in LMICs to reject COVID-19 vaccination is of global concern, since a lag in vaccination in the developing world could facilitate the spread of new variants of the virus to other countries. \DIFaddbegin \DIFadd{These ``new variants of concern'' might infect people regardless of previous immunization or vaccination, increase severity of symptoms or spread more rapidly. Strains as those from the UK, Brazil and South Africa are currently under close scrutiny.\textsuperscript{\protect\hyperlink{ref-ong2021lack}{18}}
}\DIFaddend 

In order to effectively promote vaccination against COVID-19 and devise messaging strategies, we need to know if people are willing to take COVID-19 vaccines, the reasons why they are willing or unwilling to do so, and the factors influencing their decision-making. For this purpose, we developed and deployed a common set of questions across 15 studies in \DIFdelbegin \DIFdel{ten LMICs in Africa}\DIFdelend \DIFaddbegin \DIFadd{Africa, South Asia, and Latin America: seven in LICs}\DIFaddend (Burkina Faso, Mozambique, \DIFdelbegin \DIFdel{Nigeria, }\DIFdelend Rwanda, Sierra Leone, Uganda), \DIFdelbegin \DIFdel{Asia }\DIFdelend \DIFaddbegin \DIFadd{five in lower middle income countries }\DIFaddend (India, Nepal, \DIFaddbegin \DIFadd{Nigeria, }\DIFaddend Pakistan), and \DIFdelbegin \DIFdel{Latin America }\DIFdelend \DIFaddbegin \DIFadd{one in an upper-middle-income country }\DIFaddend (Colombia). We compare these findings \DIFdelbegin \DIFdel{in LMICs }\DIFdelend to those from two \DIFdelbegin \DIFdel{higher income countries (}\DIFdelend \DIFaddbegin \DIFadd{countries at the forefront of vaccine research and development, }\DIFaddend Russia and the United States\DIFdelbegin \DIFdel{).
}\DIFdelend \DIFaddbegin \DIFadd{. We aimed for regional, geographic and demographic diversity in our study to inform policy decisions. To select the countries and samples, we did an internal search within Innovations for Poverty Action (IPA), the International Growth Center (IGC) and the Berlin Social Science Center (WZB) of projects either already in the field or with plans to conduct survey work in the second half of 2020. Study PIs agreed to include a small set of common questions about COVID-19 vaccines attitudes. This strategy was guided by the need to collect information quickly and in a cost-effective way. The final set of samples included here therefore reflects current research priorities at IGC, IPA and WZB and, in the case of IPA and IGC, donors that prioritize working with the global poor.
}\DIFaddend 
...
We find limited evidence of variation across demographic subgroups in LMICs, as shown in Table \ref{tab:dmeans}. Women were generally less willing to accept the vaccine (average difference about 4.3 points, significant at \(p<.01\)). \DIFdelbegin \DIFdel{Younger respondents (defined as aged \textless55 given younger-skewing populations in LMICs}\DIFdelend \DIFaddbegin \DIFadd{Young respondents (less than 24 years old}\DIFaddend ) were marginally more willing to take the vaccine \DIFaddbegin \DIFadd{with respect to older groups}\DIFaddend , but this difference was not statistically significant. Less educated people were on average more willing to take the vaccine in LMICs, but this difference was not significant.
...
The most common reason given for vaccine acceptance was personal protection against COVID-19 infection. The average across \DIFdelbegin \DIFdel{LMICs }\DIFdelend \DIFaddbegin \DIFadd{the LMIC samples }\DIFaddend was 91\% (86--96). In every individual study, it ranked as the first reason. In distant second place, LMIC respondents reported willingness to take the COVID-19 vaccine in order to protect their families. The average across LMICs was 36\% (28--43). In comparison to self-protection, protecting the community did not feature prominently among the stated reasons.
...
%DIFDELCMD < %%%
\DIFdel{Other concerns that make many respondents unwilling to take the vaccine could be countered by accurately presenting the scientific data to the public. }\DIFdelend Studies Uganda 2 (31\%, 25.9--36.2), Mozambique (29.7\%, 18.6--40.8) and Pakistan 1 (26\%, 18--34) showed relatively high levels of skepticism about vaccine effectiveness. This is also true for respondents in Russia (29.6\%, 28.1--31.1) and the USA (46.8\%, 41--52.6).
\DIFdelbegin \DIFdel{Recent clinical trials reveal very high rates of vaccine efficacy,\textsuperscript{\protect\hyperlink{ref-baden2021efficacy}{16},\protect\hyperlink{ref-polack2020safety}{17}} and clearly communicating these results to the public is a high priority. In contrast, conspiracy theories were rarely mentioned by respondents in any of our study samples, in spite of widespread popular discourse about anti-vaxxer movements and theories in higher-income countries.\textsuperscript{\protect\hyperlink{ref-loomba_measuring_2021}{18}}
}\DIFdelend 
...
\DIFdelbegin \DIFdel{The analysis above identifies the nature of the information gaps that any vaccine messaging should target, while in }\DIFdelend \DIFaddbegin \DIFadd{In }\DIFaddend Figure \ref{fig:fig3paper} we \DIFdelbegin \DIFdel{try to identify the actors who are best placed to deliver those messages. We }\DIFdelend asked respondents about their most trusted source of information when deciding whether to take the vaccine\DIFdelbegin \DIFdel{, because these sources are vital to disease control strategies during public health emergencies. \textsuperscript{\protect\hyperlink{ref-siegrist2014role}{19}} }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend Results from Figure \ref{fig:fig3paper} are reproduced as Table \ref{tab:trust} in \protect\hyperlink{appendixd}{Appendix A} \DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{and a complete description of the recoding of responses from individual studies is included in Table \ref{tab:q4},
}\DIFaddend 

We find striking consistency across countries. In all but one study, \DIFaddbegin \DIFadd{including those from Russia and the USA, }\DIFaddend respondents identified the health system as the most trustworthy source to help them decide whether or not to take the COVID-19 vaccine\DIFaddbegin \DIFadd{. The average across LMICs was 48.1, 19.3, 16.8, 10.6, 5.3, 2.4, 1.5\% (31.6, 8.3, 6.1, 0.7, 1, -0.1, -0.2--64.5, 30.3, 27.5, 20.5, 9.6, 4.9, 3.3). Studies Sierra Leone 2 }\DIFaddend (\DIFdelbegin \DIFdel{with the exception of Rwanda, where the government in general was identified as the most trusted source, with the health system a close second). Family and friends were the }\DIFdelend \DIFaddbegin \DIFadd{89.3\%, 87.2--91.5), Nigeria (58\%, 55.7--60.2) and Burkina Faso (51.6\%, 48.5--54.8) had the highest trust in health workers.
}

\DIFadd{The }\DIFaddend next most important reference \DIFdelbegin \DIFdel{points in most samples. Across }\DIFdelend \DIFaddbegin \DIFadd{point for trustworthy sources came from family and friends in the studies Colombia (36.6\%, 33.5--39.7), Nepal (35.6\%, 32.9--38.3), Russia (28.1\%, 26.8--29.3) and Burkina Faso (18.4\%, 16--20.9). . Across the pooled }\DIFaddend samples, women were 3 percentage points more likely to rely on family and friends than male respondents, though this difference was not significant at conventional levels (Figure \ref{fig:genderhist} in \protect\hyperlink{appendixd}{Appendix D}).
\DIFaddbegin 

\DIFaddend By contrast, \DIFdelbegin \DIFdel{endorsements }\DIFdelend \DIFaddbegin \DIFadd{in the studies Sierra Leone 1 (32.5\%, 29.7--35.4), Uganda 2 (32.4\%, 29.9--35), USA (29.7\%, 27--32.3) and Nigeria (18\%, 16.2--19.8), trust in government came second as a trusted source. Eendorsements }\DIFaddend by religious leaders or celebrity figures were not seen as important sources of influence in any sample other than Nepal \DIFaddbegin \DIFadd{(16.1\%, 13.3--18.9)}\DIFaddend .

\DIFaddbegin \DIFadd{Finally, we point towards two idiosyncratic trusted sources of particular studies that are included in the ``Other'' category but are worth mentioning due to its relative importance in each sample. In Rwanda, around 34\% of respondents said that they would trust themselves to decide to take a vaccine, making this the highest response in the sample. In the USA sample, around 14\% considered Joe Biden a trusted source, even while by the time of the survey he was still president elect.
}
...
To our knowledge, this is the first study \DIFaddbegin \DIFadd{that focuses on }\DIFaddend documenting rates of expressed COVID-19 vaccine acceptance and hesitancy \DIFdelbegin \DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{to include }\DIFaddend a large set of \DIFdelbegin \DIFdel{LMICs}\DIFdelend \DIFaddbegin \DIFadd{low-income and lower-middle-income countries from different regions}\DIFaddend . Our findings show variable but broadly high levels of prospective COVID-19 vaccine acceptance across LMICs using data from 45,928 respondents in 13 original household surveys from Africa (Burkina Faso, Mozambique, Nigeria, Rwanda, Sierra Leone, Uganda), Asia (\DIFdelbegin \DIFdel{Bangladesh, }\DIFdelend India, Nepal, Pakistan), and Latin America (Colombia). Acceptance across \DIFdelbegin \DIFdel{LMIC }\DIFdelend \DIFaddbegin \DIFadd{the LMICs included in our study }\DIFaddend averages 80.3, ranging between 66.5 and 96.6. We document considerably lower levels of acceptance in Russia and the United States.

\DIFdelbegin \DIFdel{Patterns }\DIFdelend \DIFaddbegin \DIFadd{Broadly, and consistent with other studies, we find vaccine acceptability is higher for men compared to women, and no difference with respect to age. In contrast, we find, acceptability does not increase with education, at least in our LMIC samples.\textsuperscript{\protect\hyperlink{ref-kreps2020factors}{7}--\protect\hyperlink{ref-wouters2021challenges}{11}}
}

\DIFadd{The first lessons from our findings is that patterns }\DIFaddend of COVID-19 vaccine hesitancy are not well predicted by existing measures of concerns about the safety of other vaccines (e.g., the Wellcome Global Monitor shown in Table \ref{tab:otherv}). Compared with other vaccines, COVID-19 vaccine acceptance is lower and more variable across LMIC samples. This suggests that concerns may apply specifically to COVID-19 vaccines rather than to vaccination more broadly.

Our study also documents reasons why respondents express intentions to take (or not take) a COVID-19 vaccine. The main reason expressed for willingness to take such a vaccine was to protect oneself. \DIFaddbegin \DIFadd{This evidence contrasts with appeals to altruistic behavior and prosocial motivations in order to promote vaccine acceptance.\textsuperscript{\protect\hyperlink{ref-chou2020considering}{19}} The potential risks and benefits to personal well-being feature much more prominently in people's stated reasons for vaccine acceptance.
}

\DIFaddend The most common reasons offered by those unwilling to take the vaccine were concerns about \DIFdelbegin \DIFdel{safety (side effects) and efficacy.
Across all contexts, health care workers were the most trusted source of information about vaccines}\DIFdelend \DIFaddbegin \DIFadd{side effects. At the moment of data collection for most of the samples in our analysis, the main information available was about the Pfizer-BioNTech vaccine, which in its trials showed that severe adverse effects (life-threatening or that require hospitalization) were very rare.\textsuperscript{\protect\hyperlink{ref-cdcadverse}{20}} This outsized concern about side effects could reflect the lack of widespread information about features of the vaccine at the time of data collection. Moreover, media coverage of the few cases of serious adverse events and spread of fake news may contribute as well to exacerbate those concerns }{[}\DIFadd{\textsuperscript{\protect\hyperlink{ref-stein2017golden}{21}}; bowles2020countering}{]}\DIFadd{.
}

\DIFadd{Concerns about side effects could also be due to worries about mild side effects from experiences with other vaccines. In the case of available COVID-19 vaccines, it has been documented that mild side effects are common but transient. These include fatigue, muscle pain, joint pain and headache, which were severe in fewer than 10\% of people in the clinical trials of tens of thousands. Severe fever occurred in fewer than 2\% of them.\textsuperscript{\protect\hyperlink{ref-wadman2020public}{22}}
}

\DIFadd{Allergic reactions from the COVID-19 vaccine seem to be extremely rare. Data from trials of the Pfizer-BioNTech vaccines shows that anaphylaxis after reported administration occurs at a rate of 11.1 cases per million vaccine doses administered.\textsuperscript{\protect\hyperlink{ref-cdcallergies}{23}} Our data reflects this -- no more than 6\% of respondents expressed concern about allergies in any of our LMIC studies.
}

\DIFadd{Since the date of our data collection, new information concerning side effects of vaccines have appeared, with the potential of shaping vaccine acceptance through increasing worries about side effects. Prominently, this involves the Astra-Zeneca vaccine, with its documented (but extremely rare) cases of thrombosis. This is of relevance to LMICs where initiatives like COVAX will be distributing 600 million shots, at present planned to be primarily from Astra-Zeneca}\DIFaddend .

\DIFaddbegin \DIFadd{Concerns about the effectiveness of the COVID-19 vaccine could be countered by accurately presenting the scientific data to the public. Recent clinical trials reveal very high rates of vaccine efficacy,\textsuperscript{\protect\hyperlink{ref-baden2021efficacy}{24},\protect\hyperlink{ref-polack2020safety}{25}} and clearly communicating these results to the public is a high priority. In contrast, conspiracy theories were rarely mentioned by respondents in any of our study samples, in spite of widespread popular discourse about anti-vaxxer movements and theories in higher-income countries.\textsuperscript{\protect\hyperlink{ref-loomba_measuring_2021}{26}}
}

\DIFaddend Our study samples offer an important window into the motivations underlying COVID-19 vaccine acceptance in LMICs, but our data are not fully nationally representative. Random digit dial samples and follow-up phone surveys, while necessary during a global pandemic, do not include individuals who reside outside coverage areas, who do not own or cannot operate cell phones, or who choose not to respond to telephone surveys. Care should also be taken in any attempt to extrapolate to the population level from the samples representative of narrow subpopulations.

If intentions reported in our LMIC samples translated into actual vaccination uptake, the rates would \DIFdelbegin \DIFdel{far exceed the range of what would be required for COVID-19 herd immunity (40-67\% in recent estimates).}\DIFdelend \DIFaddbegin \DIFadd{meet or exceed the herd immunity threshold for COVID-19 based on the predominant variant in circulation in these countries (current estimate: 60-80\% }{[}\DIFadd{omer2020herd;;\textsuperscript{\protect\hyperlink{ref-aschwanden2021five}{27}}{]}.}\DIFaddend \textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-britten2020}{20}%%%
\DIFdel{,}%DIFDELCMD < \protect\hyperlink{ref-haley2020}{21}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-mcneil_2021}{28}\DIFaddend } However, reported intent may not materialize into actual vaccine adoption.\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-mceachanetal2011}{22}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-mceachanetal2011}{29}\DIFaddend } The high salience of COVID-19 due to extensive media coverage and government mitigation efforts and excitement around vaccine release may have increased reported intention. \DIFdelbegin \DIFdel{\textsuperscript{\protect\hyperlink{ref-chen1996}{23}} }\DIFdelend Results from the first COVID-19 vaccine Phase 3 clinical trial were announced before some surveys were fielded; during others, subsequent approvals were granted. The fast-moving information environment may change people's perceptions about vaccines by the time they are widely available in LMICs.

\DIFaddbegin \DIFadd{Indeed, the lower acceptance rates we observe in Russia and the United States may be partly attributed to greater proximity in time to the (anticipated) initiation of vaccine roll-out, both in relation to the administration of the surveys and to vaccine development. Open-ended survey responses in the USA sample emphasized concerns about the speed of vaccine development. This may be less of a barrier to actual vaccine uptake in countries where roll-out takes place later. In Russia, we observe higher rates of acceptance of domestic vaccines compared to foreign ones. This suggests that premature roll-out of Russian Sputnik V vaccine combined with its disproportionate promotion by the government have contributed to hesitancy. Previous research on vaccine hesitancy has emphasized how the concerns that arise surrounding vaccination campaigns are often case- and context-specific,\textsuperscript{\protect\hyperlink{ref-larson2011addressing}{30}} making it difficult to predict exactly how COVID-19 vaccines will be received in any given setting.
}

\DIFaddend Nonetheless, our findings provide some specific guidance on how to design messaging to boost COVID-19 vaccine acceptance and uptake in LMICs. Our data have implications for both what the content of the message should be, and who should deliver the message.

First, high levels of trust in the advice of health workers and governments on COVID-19 vaccine decision-making suggest that social and behavioral change communication (SBCC) strategies that engage local health workers may be particularly effective tools to encourage timely and complete vaccine uptake, and to combat remaining vaccine hesitancy. The literature has explored messaging strategies to promote welfare-improving behaviors, with considerable attention paid to celebrity endorsements.\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-alatas2019celebrities}{24}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-alatas2019celebrities}{31}\DIFaddend } \DIFaddbegin \DIFadd{However, our data shows that celebrities are not a major source of trust for COVID-19 advice.
}

\DIFaddend Our data strongly support the view\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-bokemper2021timing}{25}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-bokemper2021timing}{32}\DIFaddend } that those \DIFaddbegin \DIFadd{actors }\DIFaddend with the most relevant expertise \DIFdelbegin \DIFdel{- as opposed to celebrities or general opinion leaders - are }\DIFdelend \DIFaddbegin \DIFadd{are the }\DIFaddend most trusted on this specific topic and are therefore best positioned to deliver the message. \DIFaddbegin \DIFadd{This includes primary care clinicians, who are in the best position to contribute to uptake, since they have been given priority of immunization against COVID-19, and are considered credible and trustworthy.\textsuperscript{\protect\hyperlink{ref-katzman2021primary}{33}}
}\DIFaddend 

Second, the average COVID-19 vaccine acceptance rate across our LMIC samples is high, approximately 80.3\%. \DIFdelbegin \DIFdel{Given such positive intentions, there may be high returns to }\DIFdelend \DIFaddbegin \DIFadd{To date, global vaccine distribution has skewed heavily toward higher-income countries.\textsuperscript{\protect\hyperlink{ref-wouters2021challenges}{11}} Our findings suggest that prioritizing distribution of vaccines to LMICs, where people are highly willing to take them, may be justified on the basis of better value, in addition to reducing inequity in access. In addition, once vaccine distribution to LMICs begins in earnest, }\DIFaddend investing in straightforward ``last-mile'' nudges \DIFdelbegin \DIFdel{that }\DIFdelend \DIFaddbegin \DIFadd{may }\DIFaddend help citizens convert \DIFaddbegin \DIFadd{positive }\DIFaddend intentions into actions. \DIFdelbegin \DIFdel{Reminder }\DIFdelend \DIFaddbegin \DIFadd{Findings from two recent large-scale studies in the United States\textsuperscript{\protect\hyperlink{ref-milkmanetal2021a}{34},\protect\hyperlink{ref-milkmanetal2021b}{35}} suggest that reminder }\DIFaddend messages from healthcare providers \DIFdelbegin \DIFdel{and messages alerting patients that vaccines have been reserved for them at an upcoming appointment }\DIFdelend \DIFaddbegin \DIFadd{of upcoming vaccination appointments }\DIFaddend may provide a low-cost encouragement to initiate and complete two-dose COVID-19 vaccinations\DIFdelbegin \DIFdel{, as was found in two recent large-scale studies in the United States. \textsuperscript{\protect\hyperlink{ref-milkmanetal2021a}{26},\protect\hyperlink{ref-milkmanetal2021b}{27}} }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend Similarly, childhood vaccination reminders plus cash incentives in Kenya substantially increased full immunization,\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-gibsonetal2017}{28}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-gibsonetal2017}{36}\DIFaddend } and cash and in-kind incentive programs in Nigeria and India have also proven effective.\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-idinsight}{29}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-idinsight}{37}\DIFaddend ,\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Banerjee2010}{30}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Banerjee2010}{38}\DIFaddend }

Third, high coverage rates of existing vaccines, coupled with respondents' reliance on friends and family as information sources, suggest that the general pro-vaccination stance of many citizens could be leveraged to convert intent to uptake. Social learning strategies and norm-setting are powerful drivers of information diffusion and behavior change in many related sectors.\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-beaman2021can}{31}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-beaman2021can}{39}\DIFaddend } Social signalling of positive attitudes toward COVID-19 vaccines may also help shift social norms toward even greater immunization acceptance and two-dose completion in the community at large.\textsuperscript{\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-karing2018social}{32}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-karing2018social}{40}\DIFaddend } \DIFaddbegin \DIFadd{Recent evidence from Latin America suggests that emphasizing social approval benefits can increase willingness to get vaccinated against COVID-19, across demographic groups among those initially hesitant.\textsuperscript{\protect\hyperlink{ref-argote2021messaging}{41}}
}\DIFaddend 

Finally, our findings offer guidance on the specific content of vaccine messaging that is likely to be most persuasive. Messaging should highlight the high efficacy rates of the COVID-19 vaccines currently on the market in reducing or eliminating disease, hospitalizations and death. Alluding to clinical data that addresses people's concerns about potential side effects should be prioritized. \DIFdelbegin \DIFdel{Messaging should also }\DIFdelend \DIFaddbegin \DIFadd{The provision of this type of basic information about COVID-19 vaccines has been shown to be particularly effective at persuading women, whom we find to be more hesitant than men on average.\textsuperscript{\protect\hyperlink{ref-argote2021messaging}{41}} Our findings additionally suggest that messaging should }\DIFaddend emphasize the direct protective benefits of the vaccine to the adopter.
...
Survey data were collected between June 2020 and January 2021. Our main outcome measure is vaccine acceptance. Across studies, we asked respondents, ``If a COVID-19 vaccine becomes available in {[}your country{]}, would you take it?''. \DIFaddbegin \DIFadd{This measure aligns with widely reported COVID-19 vaccine acceptance measures }{[}\DIFadd{\textsuperscript{\protect\hyperlink{ref-fisheretal2020}{\textbf{fisheretal2020?}}};;\textsuperscript{\protect\hyperlink{ref-maliketal2020}{\textbf{maliketal2020?}}};\textsuperscript{\protect\hyperlink{ref-woutersetal2021}{\textbf{woutersetal2021?}}};\textsuperscript{\protect\hyperlink{ref-lazarusetal2020}{\textbf{lazarusetal2020?}}} kreps2020factors;;\textsuperscript{\protect\hyperlink{ref-shekhar2021covid}{8}}{]}.\textsuperscript{\protect\hyperlink{ref-dror2020vaccine}{9}} }\DIFaddend If the respondent answered yes to this question, we followed up with the question, ``Why would you take it? {[}the COVID-19 vaccine{]}''. If the respondent said they would not be willing to take the vaccine, we followed up with the question, ``Why would you not take it? {[}the COVID-19 vaccine{]}''. Finally, regardless of their expressed willingness to take the vaccine, we asked about actors and institutions \DIFdelbegin \DIFdel{who would be }\DIFdelend \DIFaddbegin \DIFadd{that would be most }\DIFaddend influential in their decision\DIFdelbegin \DIFdel{. The question was worded in the following way}\DIFdelend : ``Which of the following people would you trust MOST to help you decide whether you would get a COVID-19 vaccine, if one becomes available?'' \DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{following.\textsuperscript{\protect\hyperlink{ref-defigueiredo2020lancet}{3}} }\DIFaddend To examine heterogeneity across demographic strata, we collected information about \DIFdelbegin \DIFdel{the }\DIFdelend gender, age, and education level of each respondent. Slight variations in questions wording and answer options across studies are documented in \protect\hyperlink{appendixb}{Appendix B}.
...
All \DIFdelbegin \DIFdel{LMIC }\DIFdelend surveys were conducted \DIFdelbegin \DIFdel{via telephone }\DIFdelend \DIFaddbegin \DIFadd{remotely }\DIFaddend to minimize in-person contact and comply with \DIFdelbegin \DIFdel{local government }\DIFdelend social distancing guidelines. Interviews were conducted by local staff in each country in local language(s). Surveying by phone made rapid, large-scale data collection possible. \DIFdelbegin \DIFdel{Surveys }\DIFdelend \DIFaddbegin \DIFadd{In two samples, the United States and Russia, surveys occurred via online polling. All surveys }\DIFaddend lasted approximately 15 to 40 minutes.

Taken together, we have data from 21,844 individuals from \DIFaddbegin \DIFadd{10 }\DIFaddend LMICs and 24,084 from the USA and Russia, for a total of 45,928 respondents.

\hypertarget{statistical-analysis}{%
\section*{Statistical Analysis}\label{statistical-analysis}}
\addcontentsline{toc}{section}{Statistical Analysis}

Vaccine acceptance was defined as the percentage of respondents who answered ``yes'' to the question, ``If a COVID-19 vaccine becomes available in {[}country{]}, would you take it?''. This was calculated combining all other answer options (``No'', ``Don't Know'' and ``Refuse'') into a single reference category. We estimated this outcome for each study with \DIFaddbegin \DIFadd{ordinary least squares with }\DIFaddend robust standard errors and employed sampling weights \DIFaddbegin \DIFadd{and clusters }\DIFaddend where available.

In addition to study-level estimates, we combined data from all studies other than the USA and Russia to calculate an aggregate estimate \DIFdelbegin \DIFdel{for all LMIC studies}\DIFdelend \DIFaddbegin \DIFadd{``All LMIC studies''}\DIFaddend . For these analyses, each included study received equal weight and standard errors were clustered at the study level. Averages in the ``All LMICs'' group then reflect the expected share across studies. In this combined analysis we also estimated the underlying heterogeneity of vaccine acceptance across studies using the between studies variance estimator \(\tau^2\) from a random effects model.

We also conducted subgroup analyses by \DIFaddbegin \DIFadd{binary measures of }\DIFaddend gender, age and education level and reported differences between groups. For \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{age, we selected a cut-off at 55 years old to acknowledge the lower life expectancy (of around 63 years)\textsuperscript{\protect\hyperlink{ref-wbage}{42}} and younger-skewing populations (only 5\% of the population is above 65 years old)\textsuperscript{\protect\hyperlink{ref-WorldBanksubSahara}{43}} of LMICs. For education, we divided the sample between respondents who had completed secondary school and those that had not. We defined these two groups as to reflect the broader schooling trends in LMICs, where out of every 100 students entering primary education, 61\% complete lower secondary education }{[}\DIFadd{world2017world}{]}\DIFadd{. For the }\DIFaddend ``All LMICs\DIFdelbegin \DIFdel{'' }\DIFdelend \DIFaddbegin \DIFadd{'\,' }\DIFaddend analyses we calculated the average of differences between subgroups within studies with standard errors clustered at the study level.

We \DIFdelbegin \DIFdel{additionally examined reported }\DIFdelend \DIFaddbegin \DIFadd{then investigated stated }\DIFaddend reasons for COVID-19 vaccine acceptance and hesitancy, \DIFdelbegin \DIFdel{as well as }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend the types of actors respondents would trust \DIFaddbegin \DIFadd{most }\DIFaddend when making the decision about whether to take a COVID-19 vaccine. Among respondents who expressed willingness to take the vaccine, we \DIFdelbegin \DIFdel{asked about several possible reasons }\DIFdelend why they would take it. For respondents unwilling to take the vaccine, we asked \DIFdelbegin \DIFdel{about several possible reasons }\DIFdelend why they would not take it. \DIFaddbegin \DIFadd{Respondents were able to provide multiple reasons for or against intended vaccine uptake. }\DIFaddend Finally, we asked all respondents \DIFdelbegin \DIFdel{, regardless of their answers to other questions, }\DIFdelend whom they would trust most to help them decide whether to get a COVID-19 vaccine. We report estimates of agreement with reasons for vaccine acceptance/hesitancy and trust in actors for individual studies and for the ``All LMICs'' group\DIFaddbegin \DIFadd{, which includes all study samples except Russia and the United States}\DIFaddend .
...
\leavevmode\DIFdelbegin %DIFDELCMD < \hypertarget{ref-mukherjee}{}%%%
...
\leavevmode\hypertarget{ref-kreps2020factors}{}%DIF > 
\CSLLeftMargin{7. }
...
\leavevmode\hypertarget{ref-shekhar2021covid}{}%DIF > 
\CSLLeftMargin{8. }
...
\leavevmode\hypertarget{ref-dror2020vaccine}{}%DIF > 
\CSLLeftMargin{9. }
...
\leavevmode\hypertarget{ref-fisher2020attitudes}{}%DIF > 
\CSLLeftMargin{10. }
...
\leavevmode\hypertarget{ref-wouters2021challenges}{}%DIF > 
\CSLLeftMargin{11. }
...
\leavevmode\hypertarget{ref-mukherjee}{}%DIF > 
\CSLLeftMargin{12. }
...
\leavevmode\DIFaddbegin \hypertarget{ref-martinez2021vaccines}{}%DIF > 
\CSLLeftMargin{15. }
...
\leavevmode\DIFaddbegin \hypertarget{ref-ong2021lack}{}%DIF > 
\CSLLeftMargin{18. }
...
\leavevmode\DIFdelbegin %DIFDELCMD < \hypertarget{ref-siegrist2014role}{}%%%
\DIFdelend \DIFaddbegin \hypertarget{ref-aschwanden2021five}{}\DIFaddend %
\DIFdelbegin %DIFDELCMD < \CSLLeftMargin{19. }
%DIFDELCMD < \CSLRightInline{Siegrist, M. \& Zingg, A. The role of public trust during pandemics: Implications for crisis communication. \emph{European Psychologist} \textbf{19}, 23 (2014).}
%DIFDELCMD < %%%
...
\leavevmode\DIFdelbegin %DIFDELCMD < \hypertarget{ref-britten2020}{}%%%
\DIFdelend \DIFaddbegin \hypertarget{ref-mcneil_2021}{}\DIFaddend %
\DIFdelbegin %DIFDELCMD < \CSLLeftMargin{20. }
%DIFDELCMD < \CSLRightInline{Britton, T., Ball, F. \& Trapman, P. A mathematical model reveals the influence of population heterogeneity on herd immunity to SARS-CoV-2. \emph{Science} \textbf{369}, 846--849 (2020).}
%DIFDELCMD < %%%
...
\leavevmode\DIFdelbegin %DIFDELCMD < \hypertarget{ref-haley2020}{}%%%
%DIF < 
%DIFDELCMD < \CSLLeftMargin{21. }
%DIFDELCMD < \CSLRightInline{Randolph, H. E. \& Barreiro, L. B. Herd immunity: Understanding COVID-19. \emph{Immunity} \textbf{52}, 737--741 (2020).}
%DIFDELCMD < 
...
\leavevmode\DIFdelbegin %DIFDELCMD < \hypertarget{ref-chen1996}{}%%%
\DIFdelend \DIFaddbegin \hypertarget{ref-larson2011addressing}{}\DIFaddend %
\DIFdelbegin %DIFDELCMD < \CSLLeftMargin{23. }
%DIFDELCMD < \CSLRightInline{Chen, R. T. \& Orenstein, W. A. Epidemiologic methods in immunization programs. \emph{Epidemiologic Reviews} \textbf{18}, 99--117 (1996).}
%DIFDELCMD < %%%
...
\leavevmode\DIFaddbegin \hypertarget{ref-katzman2021primary}{}%DIF > 
\CSLLeftMargin{33. }
...
\leavevmode\DIFdelbegin %DIFDELCMD < \hypertarget{ref-Duch2021}{}%%%
\DIFdelend \DIFaddbegin \hypertarget{ref-argote2021messaging}{}\DIFaddend %
\DIFdelbegin %DIFDELCMD < \CSLLeftMargin{33. }
%DIFDELCMD < \CSLRightInline{Duch, R. \emph{et al.} Who should be first in line for the COVID-19 vaccine? Surveys in 13 countries of the public{'}s preferences for prioritisation. \emph{medRxiv} (2021).}
%DIFDELCMD < %%%
...
\leavevmode\DIFdelbegin %DIFDELCMD < \hypertarget{ref-lazarus2020nature}{}%%%
\DIFdelend \DIFaddbegin \hypertarget{ref-wbage}{}\DIFaddend %
\DIFdelbegin %DIFDELCMD < \CSLLeftMargin{34. }
%DIFDELCMD < \CSLRightInline{Lazarus, J. V. \emph{et al.} A global survey of potential acceptance of a COVID-19 vaccine. \emph{Nature Medecine} 1--4 (2020).}
%DIFDELCMD < %%%
...
\leavevmode\DIFaddbegin \hypertarget{ref-WorldBanksubSahara}{}%DIF > 
\CSLLeftMargin{43. }
...
\leavevmode\hypertarget{ref-Duch2021}{}%DIF > 
\CSLLeftMargin{44. }
...
\DIFaddbegin \leavevmode\hypertarget{ref-omer2020herd}{}%DIF > 
\CSLLeftMargin{46. }
...
\leavevmode\hypertarget{ref-chen1996}{}%DIF > 
\CSLLeftMargin{47. }
...
\DIFaddbegin \begin{landscape}\begin{table}[!h]

\caption{\label{tab:sampling}\DIFaddFL{Summary of studies sampling}}
\centering
\resizebox{\linewidth}{!}{
\fontsize{10}{12}\selectfont
...
\caption{\DIFdelbeginFL \DIFdelFL{Summary of studies sampling}\DIFdelendFL \label{tab:maintabledis}If a COVID-19 vaccine becomes available in [country], would you take it? Disaggregated by subgroups}
\centering
\DIFdelbeginFL \DIFdelendFL \DIFaddbeginFL \resizebox{\linewidth}{!}{
\fontsize{10}{12}\selectfont
\begin{threeparttable}
...
India & 84.6 & 80.8 & 85.6 & 89.4 & 85.8 & 78.8 & 85.4 & 85.1\\
 & (82.8, 86.4) & (77.6, 84.1) & (83.7, 87.5) & (83.5, 95.4) & (82.6, 88.9) & (73.9, 83.7) & (83.5, 87.3) & (80.8, 89.4)\\
...
%DIFDELCMD < \begin{tabular}[t]{>{\raggedright\arraybackslash}p{7em}>{\centering\arraybackslash}p{7em}>{\centering\arraybackslash}p{7em}>{\centering\arraybackslash}p{7em}>{\centering\arraybackslash}p{7em}>{\centering\arraybackslash}p{7em}>{\centering\arraybackslash}p{7em}>{\centering\arraybackslash}p{7em}}
%DIFDELCMD < \toprule
%DIFDELCMD < \multicolumn{2}{c}{\textbf{ }} & \multicolumn{3}{c}{\textbf{Protection}} & \multicolumn{2}{c}{\textbf{If recommended by}} & \multicolumn{1}{c}{\textbf{ }} \\
%DIFDELCMD < \cmidrule(l{3pt}r{3pt}){3-5} \cmidrule(l{3pt}r{3pt}){6-7}
%DIFDELCMD < \textbf{Study} & \textbf{N} & \textbf{Self} & \textbf{Family} & \textbf{Community} & \textbf{Health workers} & \textbf{Government} & \textbf{Other}\\
%DIFDELCMD < \midrule
%DIFDELCMD < Burkina Faso & 651 & 76 & 42 & 7 & 6 & 19 & 2\\
%DIFDELCMD <  &  & (73, 79) & (38, 46) & ( 5,  9) & ( 4,  8) & (16, 22) & ( 1,  3)\\
%DIFDELCMD < Colombia & 756 & 91 & 23 & 12 & 1 & 2 & 6\\
%DIFDELCMD <  &  & (88, 93) & (20, 26) & (10, 14) & ( 0,  2) & ( 1,  3) & ( 4,  7)\\
%DIFDELCMD < Mozambique & 768 & 83 & 32 & 4 & . & 7 & 3\\
%DIFDELCMD <  &  & (80, 86) & (27, 38) & ( 2,  5) & . & ( 5,  8) & ( 2,  4)\\
%DIFDELCMD < Nepal & 1341 & 96 & 34 & 20 & 2 & 3 & 7\\
%DIFDELCMD <  &  & (95, 98) & (32, 37) & (17, 22) & ( 1,  2) & ( 2,  4) & ( 5,  9)\\
%DIFDELCMD < Nigeria & 1424 & 89 & 35 & 21 & . & 6 & 4\\
%DIFDELCMD <  &  & (88, 91) & (33, 38) & (19, 23) & . & ( 4,  7) & ( 3,  5)\\
%DIFDELCMD < Rwanda & 1152 & 98 & 26 & 11 & 1 & 5 & 1\\
%DIFDELCMD <  &  & (97, 99) & (23, 28) & ( 9, 13) & ( 0,  1) & ( 4,  6) & ( 1,  2)\\
%DIFDELCMD < Sierra Leone 1 & 836 & 94 & 37 & 21 & 12 & 23 & 7\\
%DIFDELCMD <  &  & (92, 96) & (34, 40) & (18, 23) & (10, 14) & (20, 25) & ( 5,  9)\\
%DIFDELCMD < Sierra Leone 2 & 1855 & 91 & 62 & 21 & 59 & . & 16\\
%DIFDELCMD <  &  & (88, 93) & (57, 66) & (16, 27) & (54, 63) & . & (11, 21)\\
%DIFDELCMD < Uganda 1 & 2885 & 96 & 36 & 9 & . & 10 & 6\\
%DIFDELCMD <  &  & (95, 97) & (34, 38) & ( 8, 10) & . & ( 9, 12) & ( 5,  7)\\
%DIFDELCMD < Uganda 2 & 1045 & 96 & 28 & 11 & 1 & 15 & 2\\
%DIFDELCMD <  &  & (95, 97) & (25, 31) & ( 9, 12) & ( 1,  2) & (13, 17) & ( 1,  3)\\
%DIFDELCMD < All LMICs & . & 91 & 36 & 14 & 12 & 10 & 5\\
%DIFDELCMD <  &  & (86, 96) & (28, 43) & ( 9, 18) & (-8, 31) & ( 4, 16) & ( 2,  8)\\
%DIFDELCMD < Russia & 5887 & 76 & 69 & 41 & 11 & 6 & 18\\
%DIFDELCMD <  &  & (74, 78) & (67, 71) & (38, 43) & (10, 13) & ( 5,  7) & (16, 20)\\
%DIFDELCMD < USA & 1313 & 94 & 92 & 89 & . & 67 & .\\
%DIFDELCMD <  &  & (92, 95) & (90, 94) & (87, 91) & . & (64, 70) & .\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \begin{tablenotes}
%DIFDELCMD < \item Table 5 shows percentage of respondents mentioning reasons why they would take the Covid-19 vaccine. The number of observations and percentage correponds only to people who would take the vaccine. Respondents in all countries could give more than one reason. A 95\% confidence interval is shown between parentheses
...
\caption{\label{tab:yes}\DIFaddFL{Reasons to take the vaccine}}
\centering
\fontsize{10}{12}\selectfont
\begin{threeparttable}
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{8em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{\centering\arraybackslash}p{4em}>{}p{4em}>{}p{4em}>{}p{4em}>{}p{4em}>{}p{4em}>{}p{4em}>{}p{4em}>{}p{4em}>{}p{4em}}
\toprule
...
\midrule
\DIFaddFL{Burkina Faso }& \DIFaddFL{77 }& \DIFaddFL{59 }& \DIFaddFL{100 }& \DIFaddFL{26 }& \DIFaddFL{64 }& \DIFaddFL{66 }& \DIFaddFL{11 }& \DIFaddFL{2 }& \DIFaddFL{0}\\
 & \DIFaddFL{( 56,  99) }& \DIFaddFL{( 46,  72) }& \DIFaddFL{(100, 100) }& \DIFaddFL{(  4,  48) }& \DIFaddFL{( 51,  77) }& \DIFaddFL{(-80, 211) }& \DIFaddFL{( -5,  26) }& \DIFaddFL{( -2,   5) }& \DIFaddFL{(  0,   0)}\\
\DIFaddFL{n }& \DIFaddFL{19 }& \DIFaddFL{57 }& \DIFaddFL{3 }& \DIFaddFL{19 }& \DIFaddFL{57 }& \DIFaddFL{3 }& \DIFaddFL{19 }& \DIFaddFL{57 }& \DIFaddFL{3}\\
\DIFaddFL{Colombia }& \DIFaddFL{91 }& \DIFaddFL{91 }& \DIFaddFL{90 }& \DIFaddFL{26 }& \DIFaddFL{26 }& \DIFaddFL{16 }& \DIFaddFL{12 }& \DIFaddFL{13 }& \DIFaddFL{14}\\
 & \DIFaddFL{( 86,  97) }& \DIFaddFL{( 88,  94) }& \DIFaddFL{( 83,  97) }& \DIFaddFL{( 17,  35) }& \DIFaddFL{( 21,  31) }& \DIFaddFL{(  8,  25) }& \DIFaddFL{(  4,  20) }& \DIFaddFL{(  9,  16) }& \DIFaddFL{(  6,  22)}\\
\DIFaddFL{n }& \DIFaddFL{90 }& \DIFaddFL{349 }& \DIFaddFL{73 }& \DIFaddFL{90 }& \DIFaddFL{349 }& \DIFaddFL{73 }& \DIFaddFL{90 }& \DIFaddFL{349 }& \DIFaddFL{73}\\
\DIFaddFL{Mozambique }& \DIFaddFL{62 }& \DIFaddFL{84 }& \DIFaddFL{80 }& \DIFaddFL{50 }& \DIFaddFL{32 }& \DIFaddFL{34 }& \DIFaddFL{12 }& \DIFaddFL{4 }& \DIFaddFL{2}\\
 & \DIFaddFL{( 19, 106) }& \DIFaddFL{( 81,  87) }& \DIFaddFL{( 75,  86) }& \DIFaddFL{(  5,  95) }& \DIFaddFL{( 26,  38) }& \DIFaddFL{( 27,  41) }& \DIFaddFL{(-17,  42) }& \DIFaddFL{(  2,   6) }& \DIFaddFL{(  0,   4)}\\
\DIFaddFL{n }& \DIFaddFL{8 }& \DIFaddFL{571 }& \DIFaddFL{188 }& \DIFaddFL{8 }& \DIFaddFL{571 }& \DIFaddFL{188 }& \DIFaddFL{8 }& \DIFaddFL{571 }& \DIFaddFL{188}\\
\DIFaddFL{Nepal }& \DIFaddFL{97 }& \DIFaddFL{97 }& \DIFaddFL{92 }& \DIFaddFL{31 }& \DIFaddFL{36 }& \DIFaddFL{27 }& \DIFaddFL{15 }& \DIFaddFL{20 }& \DIFaddFL{19}\\
 & \DIFaddFL{( 94, 100) }& \DIFaddFL{( 96,  98) }& \DIFaddFL{( 87,  97) }& \DIFaddFL{( 25,  37) }& \DIFaddFL{( 33,  39) }& \DIFaddFL{( 19,  36) }& \DIFaddFL{( 10,  20) }& \DIFaddFL{( 17,  23) }& \DIFaddFL{( 13,  25)}\\
\DIFaddFL{n }& \DIFaddFL{225 }& \DIFaddFL{890 }& \DIFaddFL{162 }& \DIFaddFL{225 }& \DIFaddFL{890 }& \DIFaddFL{162 }& \DIFaddFL{225 }& \DIFaddFL{890 }& \DIFaddFL{162}\\
\DIFaddFL{Nigeria }& \DIFaddFL{91 }& \DIFaddFL{89 }& \DIFaddFL{94 }& \DIFaddFL{31 }& \DIFaddFL{36 }& \DIFaddFL{31 }& \DIFaddFL{22 }& \DIFaddFL{21 }& \DIFaddFL{21}\\
 & \DIFaddFL{( 87,  95) }& \DIFaddFL{( 87,  91) }& \DIFaddFL{( 89, 100) }& \DIFaddFL{( 25,  38) }& \DIFaddFL{( 33,  39) }& \DIFaddFL{( 20,  42) }& \DIFaddFL{( 16,  29) }& \DIFaddFL{( 18,  23) }& \DIFaddFL{( 11,  31)}\\
\DIFaddFL{n }& \DIFaddFL{178 }& \DIFaddFL{1175 }& \DIFaddFL{71 }& \DIFaddFL{178 }& \DIFaddFL{1175 }& \DIFaddFL{71 }& \DIFaddFL{178 }& \DIFaddFL{1175 }& \DIFaddFL{71}\\
\DIFaddFL{Rwanda }& \DIFaddFL{98 }& \DIFaddFL{98 }& \DIFaddFL{100 }& \DIFaddFL{22 }& \DIFaddFL{28 }& \DIFaddFL{29 }& \DIFaddFL{10 }& \DIFaddFL{11 }& \DIFaddFL{10}\\
 & \DIFaddFL{( 97, 100) }& \DIFaddFL{( 97,  99) }& \DIFaddFL{(100, 100) }& \DIFaddFL{( 17,  26) }& \DIFaddFL{( 24,  31) }& \DIFaddFL{( 12,  46) }& \DIFaddFL{(  7,  13) }& \DIFaddFL{(  9,  14) }& \DIFaddFL{( -1,  21)}\\
\DIFaddFL{n }& \DIFaddFL{389 }& \DIFaddFL{732 }& \DIFaddFL{31 }& \DIFaddFL{389 }& \DIFaddFL{732 }& \DIFaddFL{31 }& \DIFaddFL{389 }& \DIFaddFL{732 }& \DIFaddFL{31}\\
\DIFaddFL{Sierra Leone 1 }& \DIFaddFL{96 }& \DIFaddFL{94 }& \DIFaddFL{94 }& \DIFaddFL{36 }& \DIFaddFL{38 }& \DIFaddFL{27 }& \DIFaddFL{24 }& \DIFaddFL{20 }& \DIFaddFL{22}\\
 & \DIFaddFL{( 93,  99) }& \DIFaddFL{( 92,  95) }& \DIFaddFL{( 86, 102) }& \DIFaddFL{( 29,  44) }& \DIFaddFL{( 34,  41) }& \DIFaddFL{( 12,  42) }& \DIFaddFL{( 17,  31) }& \DIFaddFL{( 16,  23) }& \DIFaddFL{(  8,  36)}\\
\DIFaddFL{n }& \DIFaddFL{167 }& \DIFaddFL{632 }& \DIFaddFL{37 }& \DIFaddFL{167 }& \DIFaddFL{632 }& \DIFaddFL{37 }& \DIFaddFL{167 }& \DIFaddFL{632 }& \DIFaddFL{37}\\
\DIFaddFL{Sierra Leone 2 }& \DIFaddFL{88 }& \DIFaddFL{90 }& \DIFaddFL{93 }& \DIFaddFL{54 }& \DIFaddFL{62 }& \DIFaddFL{62 }& \DIFaddFL{28 }& \DIFaddFL{22 }& \DIFaddFL{18}\\
 & \DIFaddFL{( 78,  97) }& \DIFaddFL{( 88,  92) }& \DIFaddFL{( 89,  97) }& \DIFaddFL{( 41,  67) }& \DIFaddFL{( 58,  67) }& \DIFaddFL{( 56,  67) }& \DIFaddFL{( 15,  40) }& \DIFaddFL{( 16,  28) }& \DIFaddFL{( 12,  25)}\\
\DIFaddFL{n }& \DIFaddFL{65 }& \DIFaddFL{1376 }& \DIFaddFL{396 }& \DIFaddFL{65 }& \DIFaddFL{1376 }& \DIFaddFL{396 }& \DIFaddFL{65 }& \DIFaddFL{1376 }& \DIFaddFL{396}\\
\DIFaddFL{Uganda 1 }& \DIFaddFL{96 }& \DIFaddFL{96 }& \DIFaddFL{. }& \DIFaddFL{34 }& \DIFaddFL{36 }& \DIFaddFL{. }& \DIFaddFL{9 }& \DIFaddFL{9 }& \DIFaddFL{.}\\
 & \DIFaddFL{( 95,  98) }& \DIFaddFL{( 96,  97) }& \DIFaddFL{. }& \DIFaddFL{( 30,  39) }& \DIFaddFL{( 34,  39) }& \DIFaddFL{. }& \DIFaddFL{(  6,  11) }& \DIFaddFL{(  8,  11) }& \DIFaddFL{.}\\
\DIFaddFL{n }& \DIFaddFL{526 }& \DIFaddFL{2218 }& \DIFaddFL{. }& \DIFaddFL{526 }& \DIFaddFL{2218 }& \DIFaddFL{. }& \DIFaddFL{526 }& \DIFaddFL{2218 }& \DIFaddFL{.}\\
\DIFaddFL{Uganda 2 }& \DIFaddFL{97 }& \DIFaddFL{96 }& \DIFaddFL{97 }& \DIFaddFL{20 }& \DIFaddFL{30 }& \DIFaddFL{28 }& \DIFaddFL{8 }& \DIFaddFL{11 }& \DIFaddFL{13}\\
 & \DIFaddFL{( 94,  99) }& \DIFaddFL{( 95,  97) }& \DIFaddFL{( 94, 100) }& \DIFaddFL{( 14,  26) }& \DIFaddFL{( 27,  33) }& \DIFaddFL{( 21,  36) }& \DIFaddFL{(  4,  11) }& \DIFaddFL{(  9,  13) }& \DIFaddFL{(  7,  19)}\\
\DIFaddFL{n }& \DIFaddFL{173 }& \DIFaddFL{749 }& \DIFaddFL{123 }& \DIFaddFL{173 }& \DIFaddFL{749 }& \DIFaddFL{123 }& \DIFaddFL{173 }& \DIFaddFL{749 }& \DIFaddFL{123}\\
\DIFaddFL{All LMICs }& \DIFaddFL{89 }& \DIFaddFL{89 }& \DIFaddFL{93 }& \DIFaddFL{33 }& \DIFaddFL{39 }& \DIFaddFL{36 }& \DIFaddFL{15 }& \DIFaddFL{13 }& \DIFaddFL{13}\\
 & \DIFaddFL{( 81,  97) }& \DIFaddFL{( 81,  98) }& \DIFaddFL{( 89,  98) }& \DIFaddFL{( 25,  41) }& \DIFaddFL{( 29,  48) }& \DIFaddFL{( 23,  48) }& \DIFaddFL{( 10,  20) }& \DIFaddFL{(  8,  18) }& \DIFaddFL{(  7,  19)}\\
\DIFaddFL{n }& \DIFaddFL{1840 }& \DIFaddFL{8749 }& \DIFaddFL{1084 }& \DIFaddFL{1840 }& \DIFaddFL{8749 }& \DIFaddFL{1084 }& \DIFaddFL{1840 }& \DIFaddFL{8749 }& \DIFaddFL{1084}\\
\DIFaddFL{Russia }& \DIFaddFL{67 }& \DIFaddFL{76 }& \DIFaddFL{81 }& \DIFaddFL{74 }& \DIFaddFL{68 }& \DIFaddFL{68 }& \DIFaddFL{46 }& \DIFaddFL{40 }& \DIFaddFL{38}\\
 & \DIFaddFL{( 59,  74) }& \DIFaddFL{( 73,  78) }& \DIFaddFL{( 76,  87) }& \DIFaddFL{( 68,  81) }& \DIFaddFL{( 66,  71) }& \DIFaddFL{( 62,  74) }& \DIFaddFL{( 38,  54) }& \DIFaddFL{( 38,  43) }& \DIFaddFL{( 32,  44)}\\
\DIFaddFL{n }& \DIFaddFL{552 }& \DIFaddFL{5108 }& \DIFaddFL{227 }& \DIFaddFL{552 }& \DIFaddFL{5108 }& \DIFaddFL{227 }& \DIFaddFL{552 }& \DIFaddFL{5108 }& \DIFaddFL{227}\\
\DIFaddFL{USA }& \DIFaddFL{92 }& \DIFaddFL{91 }& \DIFaddFL{97 }& \DIFaddFL{89 }& \DIFaddFL{91 }& \DIFaddFL{94 }& \DIFaddFL{90 }& \DIFaddFL{89 }& \DIFaddFL{89}\\
 & \DIFaddFL{( 88,  96) }& \DIFaddFL{( 89,  94) }& \DIFaddFL{( 95,  99) }& \DIFaddFL{( 83,  95) }& \DIFaddFL{( 88,  93) }& \DIFaddFL{( 91,  97) }& \DIFaddFL{( 85,  95) }& \DIFaddFL{( 86,  92) }& \DIFaddFL{( 85,  93)}\\
\DIFaddFL{n }& \DIFaddFL{153 }& \DIFaddFL{687 }& \DIFaddFL{473 }& \DIFaddFL{153 }& \DIFaddFL{687 }& \DIFaddFL{473 }& \DIFaddFL{153 }& \DIFaddFL{687 }& \DIFaddFL{473}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \DIFaddFL{Table 2 shows percentage of respondents mentioning reasons why they would take the Covid-19 vaccine. The number of observations and percentage correponds only to people who would take the vaccine. Respondents in all countries could give more than one reason. A 95\% confidence interval is shown between parentheses. Studies India, Pakistan 1 and Pakistan 2 are not included because they either did not include the question or were not properly harmonized with the other studies.
}\end{tablenotes}
\end{threeparttable}
\end{table}
...
\DIFaddend \begin{landscape}\begin{table}[!h]
...
\emph{Sampling Weights:} Post-stratification weights are computed to match marginal \DIFdelbegin \DIFdel{population }\DIFdelend distributions of age, gender and education \DIFaddbegin \DIFadd{among the adult population of Russia }\DIFaddend with target proportions coming from the 2019 Yearbook and 2015 Microcensus released by Russian Federal Bureau of National Statistics (Rosstat).
